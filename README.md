...
Software that marks (applies conditional formatting) excel spreadsheet's for lecturer's. MYS will compare an answer spreadsheet (template) with your student's assignment spreadsheet's. The template is what you would like to be compared and is created by the lecturer.
