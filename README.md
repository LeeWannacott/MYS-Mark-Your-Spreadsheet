...
Software that applies conditional formatting (highlighting) and marks student excel spreadsheet's for lecturers. MYS will compare an answer spreadsheet (template) with your student assignment's (folder containing students xlsx files). The template is what you would like to be compared and is created by the lecturer. Refer to the images near the bottom of the document for examples.
